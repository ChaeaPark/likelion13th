  ...
  return (
    <main className="relative bg-gradient-to-br from-purple-100 to-indigo-100 min-h-screen flex justify-center px-4 py-10">
      ...
      <section className="w-full max-w-[1280px] flex flex-col items-start gap-8">
        <h1 className="text-3xl md:text-5xl font-extrabold text-gray-800">Welcome to ShopMall</h1>
        <p className="text-base md:text-lg text-gray-700">Discover our latest products and deals</p>
        <div className="w-full flex flex-col gap-4">
          <div className="text-base md:text-lg tracking-widest text-gray-500">Featured Products</div>
